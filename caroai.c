...
//     for(j = 0; j < size; j++){
//       if(i == row && j == col){
//         printf("\033[0;37m[ \033[0;37m%d \033[0;37m]", table[i * size + j]); // white
//       }
//       else{
//         if(table[i * size + j] == 'x')
//           printf("\033[0;36m[ \033[0;33m%d \033[0;36m]", table[i * size + j]); // yellow
//         else if (table[i * size + j] == 'o')
//           printf("\033[0;36m[ \033[0;31m%d \033[0;36m]", table[i * size + j]); // red
//         else
//           printf("\033[0;36m[ \033[0;35m%d \033[0;36m]", table[i * size + j]); // bue
//       }
//     }    
//     printf("\n");
//   }
...
//   if(isNullCell(*col - i, *row)){
//     if(count == 1)
//       setCEll(*col - i, *row, min(5 + (getCell(*col - i, *row) / 10) * 10, getCell(*col - i, *row) + 5));
//     else  
//       setCEll(*col - i, *row, max(count + (getCell(*col - i, *row) / 10) * 10, getCell(*col - i, *row) + 1));
//     for(i = i + 1; getCell(*col - i, *row) == cpu; i++);  
//     if(isNullCell(*col - i, *row))
...
//   if(isNullCell(*col + j, *row)){
//     if(count == 1)
//       setCEll(*col + j, *row, min(5 + (getCell(*col + j, *row) / 10) * 10, getCell(*col + j, *row) + 5));
//     else
//       setCEll(*col + j, *row, max(count + (getCell(*col + j, *row) / 10) * 10, getCell(*col + j, *row) + 1));
//     for(j = j + 1; getCell(*col + j, *row) == cpu; j++);  
//     if(isNullCell(*col + j, *row))
...
//   if(isNullCell(*col, *row - i)){
//     if(count == 1)
//       setCEll(*col, *row - i, min(5 + (getCell(*col, *row - i) / 10) * 10, getCell(*col, *row - i) + 5));
//     else
//       setCEll(*col, *row - i, max(count + (getCell(*col, *row - i) / 10) * 10, getCell(*col, *row - i) + 1));
//     for(i = i + 1; getCell(*col, *row - i) == cpu; i++);  
//     if(isNullCell(*col, *row - i))
...
//   if(isNullCell(*col, *row + j)){
//     if(count == 1)
//       setCEll(*col, *row + j, min(5 + (getCell(*col, *row + j) / 10) * 10, getCell(*col, *row + j) + 5));
//     else
//       setCEll(*col, *row + j, max(count + (getCell(*col, *row + j) / 10) * 10, getCell(*col, *row + j) + 1));
//     for(j = j + 1; getCell(*col, *row + j) == cpu; j++);  
//     if(isNullCell(*col, *row + j))
...
//   if(isNullCell(*col - i, *row - i)){
//     if(count == 1)
//       setCEll(*col - i, *row - i, min(5 + (getCell(*col - i, *row - i) / 10) * 10, getCell(*col - i, *row - i) + 5));
//     else  
//       setCEll(*col - i, *row - i, max(count + (getCell(*col - i, *row - i) / 10) * 10, getCell(*col - i, *row - i) + 1));
//     for(i = i + 1; getCell(*col - i, *row - i) == cpu; i++);  
//     if(isNullCell(*col - i, *row - i))
...
//   if(isNullCell(*col + j, *row + j)){
//     if(count == 1)
//       setCEll(*col + j, *row + j, min(5 + (getCell(*col + j, *row + j) / 10) * 10, getCell(*col + j, *row + j) + 5));
//     else    
//       setCEll(*col + j, *row + j, max(count + (getCell(*col + j, *row + j) / 10) * 10, getCell(*col + j, *row + j) + 1));
//     for(j = j + 1; getCell(*col + j, *row + j) == cpu; j++);  
//     if(isNullCell(*col + j, *row + j))
...
//   if(isNullCell(*col - i, *row + i)){
//     if(count == 1)
//       setCEll(*col - i, *row + i, min(10 + (getCell(*col - i, *row + i) / 10) * 10, getCell(*col - i, *row + i) + 1));
//     else
//       setCEll(*col - i, *row + i, max(count + (getCell(*col - i, *row + i) / 10) * 10, getCell(*col - i, *row + i) + 1));
//     for(i = i + 1; getCell(*col - i, *row + i) == cpu; i++);  
//     if(isNullCell(*col - i, *row + i))
...
//   if(isNullCell(*col + j, *row - j)){
//     if(count == 1)
//     setCEll(*col + j, *row - j, min(10 + (getCell(*col + j, *row - j) / 10) * 10, getCell(*col + j, *row - j) + 1));
//     else   
//     setCEll(*col + j, *row - j, max(count + (getCell(*col + j, *row - j) / 10) * 10, getCell(*col + j, *row - j) + 1));
//   for(j = j + 1; getCell(*col + j, *row - j) == cpu; j++);  
//   if(isNullCell(*col + j, *row - j))
